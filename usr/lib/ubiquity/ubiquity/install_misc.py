...
def chroot_cleanup(target, x11=False):
    ...
    chrex(target, 'cp', '/usr/meanOs/systemX/Shared/CoreMsc/grub','/etc/default/grub')
    ...
    chrex(target, 'rm', '/usr/meanOs/live')
    #chrex(target, 'cp', '/usr/meanOs/systemX/Shared/CoreMsc/grub','/etc/default/grub')
    #chrex(target, 'cp', '/usr/meanOs/systemX/Shared/CoreMsc/lsb-release','/etc/lsb-release')
    #chrex(target, 'cp', '/usr/meanOs/systemX/Shared/CoreMsc/hostname','/etc/hostname')
    #chrex(target, 'update-grub')
